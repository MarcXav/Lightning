...
print("Creating graph in PyTorch",end="\n\n")
...
print("Initialized tensor with Glorot")
print(w)
print()
...
print(f"Computing the gradients of the loss")
print('dL/dw : ', w.grad)
print('dL/db : ', b.grad)

# verifying the computed gradient dL/dw
print(f"verifying the computed gradient dL/dw")
print(2 * x * ((w * x + b) - y))
print()
...
print(f"Implementing models based on nn.Sequential")
...
print(f"XOR classification problem",end="\n\n")
...
plt.title("1. XOR classification", fontsize=14)

plt.savefig('figures/13_01.png', dpi=300)
plt.show() 
...
print(f"first nn.Sequential model for XOR classification problem")
print(model)
print()
...
plt.suptitle("2. first nn.Sequential model for XOR classification", fontsize=14)

plt.savefig('figures/13_02.png', dpi=300)
plt.show() 


print(f"second nn.Sequential model for XOR classification problem")
model = nn.Sequential(
    nn.Linear(2, 4),
    nn.ReLU(),
    nn.Linear(4, 4),
...
plt.suptitle("3. second nn.Sequential model for XOR classification", fontsize=14)
...
# 
# 
print(f"Making model building more flexible with nn.Module",end="\n\n")
...
model = MyModule()
print(f"nn.Module for XOR classification problem")
print(model)
print()
...
plt.suptitle("4. Using nn.Module", fontsize=14)
...
# 
print(f"Writing custom layers in PyTorch - NoisyLinear example",end="\n\n")
...
plt.suptitle("5. Customized with noisy_layer added", fontsize=14)
plt.show()
